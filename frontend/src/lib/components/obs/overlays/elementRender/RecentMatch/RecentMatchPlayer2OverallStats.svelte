...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallBeneficialTradeRatio}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallCounterHitCount}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallCounterHitRatio}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallDamageTotal}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallOpeningsTotal}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallDamagePerOpening}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallOpeningsPerKill}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallDigitalInputsTotal}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallDigitalInputsPerMinute}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallDigitalInputsPerSecond}
	<TextElement {style} {dataItem}>
		{overall?.digitalInputsPerMinute.count !== undefined
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallInputsTotal}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallInputsPerMinute}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallInputsPerSecond}
	<TextElement {style} {dataItem}>
		{![overall?.inputsPerMinute.count, playerIndex].some((e) => e === undefined || e === null)
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallNeutralWinsCount}
	<TextElement {style} {dataItem}>
...
{:else if dataItem?.elementId === CustomElement.PostGameMatchPlayer2OverallNeutralWinsRatio}
	<TextElement {style} {dataItem}>
