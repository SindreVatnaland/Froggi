...
const CHALLENGE_CATEGORY: Partial<Record<BingoChallengeId, string>> = {
	...
	win_high_apm:            'execution',
	edgeguard_rate:          'execution',
	win_low_damage_dealt:    'win',
	rest_kill:               'kill_method',
	falcon_punch_kill:       'kill_method',
	gwm_judge_kill:          'kill_method',
	peach_turnip_hold:       'execution',
	yoshi_egg_lay:           'execution',
