	...
	simulateGame = async () => {
		...
		try {
			for (const key of sortedKeys) {
				...
				// Flat 16ms wait after processing: effective ~30fps under load, but a steady rate and
				// lower CPU than chasing 60fps — the preview looks the same and stays consistent.
